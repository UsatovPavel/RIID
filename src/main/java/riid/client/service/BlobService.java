...
public class BlobService implements BlobServiceApi {
    ...
    @Override
    @SuppressWarnings("PMD.CloseResource") // рефакторинг после убирания этого supress в RegistryClientImpl провалился. неочевидно как без supresss здесь реализовывать
