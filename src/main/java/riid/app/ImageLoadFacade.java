...
public final class ImageLoadFacade {
    ...
    public static ImageLoadFacade createFromConfig(Path configPath, Credentials credentialsOverride) throws Exception {
        ...
        Map<String, RuntimeAdapter> runtimes = defaultRuntimes();
        ...
        HttpClientConfig httpConfig = config.client() != null && config.client().http() != null
                ? config.client().http()
