...
- **`riid-image-sizes.json`** — tar size bucket counts and load duration p50/p95 by bucket; ordering via recording rule `riid:image_load:tar_category_sortidx` (see `../prometheus-rules/riid-recording-rules.yaml` + `../README.md` vmalert).
